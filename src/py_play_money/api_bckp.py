...
#             logger.info(
#                 "No key provided, won't be able to execute authenticated requests."
#             )
#         else:
...
#         def __call__(self, market_id: str, **kwargs) -> Market:
#             """Allow direct calling: client.market(market_id=...)"""
#             return self.by_id(market_id, **kwargs)

#         def by_id(self, market_id: str, **kwargs) -> Market:
